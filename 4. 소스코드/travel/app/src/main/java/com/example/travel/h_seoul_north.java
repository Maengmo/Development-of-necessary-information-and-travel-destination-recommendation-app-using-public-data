...
public class h_seoul_north extends AppCompatActivity {
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h_seoul_north);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(h_seoul_north.this,
                        h_seoul_north_eunpyung.class);
        ...
        i.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(h_seoul_north.this,
                        h_seoul_north_dongdaemoon.class);
                startActivity(intent);
            }
        });
        ...
        m.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(h_seoul_north.this,
                        h_seoul_north_kwanghwamoon.class);
                startActivity(intent);
            }
        });
        ...
        s.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(h_seoul_north.this,
                        h_seoul_north_kwangjingoo.class);
                startActivity(intent);
            }
        });
